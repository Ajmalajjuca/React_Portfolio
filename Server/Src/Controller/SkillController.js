...
export const postSkills = async (req, res) => {
    ...
    try {
        ...
        const newSkill = new Skill({ name, category, logo: '/uploads/' + file.filename });
...
export const updateSkill = async (req, res) => {
    ...
    const file = req.file;
    try {
        const updatedSkill = await Skill.findByIdAndUpdate(id, { name, category, logo: '/uploads/' + file.filename }, { new: true });
